...
template <> constexpr inline auto MenuPage::qt_create_metaobjectdata<qt_meta_tag_ZN8MenuPageE_t>()
{
    ...
    QtMocHelpers::UintData qt_methods {
        // Signal 'takePhotosClicked'
        QtMocHelpers::SignalData<void()>(1, 2, QMC::AccessPublic, QMetaType::Void),
        // Signal 'uploadPhotosClicked'
...
void MenuPage::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: _t->takePhotosClicked(); break;
        case 1: _t->uploadPhotosClicked(); break;
        default: ;
        }
    }
    if (_c == QMetaObject::IndexOfMethod) {
        if (QtMocHelpers::indexOfMethod<void (MenuPage::*)()>(_a, &MenuPage::takePhotosClicked, 0))
            return;
        if (QtMocHelpers::indexOfMethod<void (MenuPage::*)()>(_a, &MenuPage::uploadPhotosClicked, 1))
            return;
    }
}
...
// SIGNAL 0
void MenuPage::takePhotosClicked()
{
    QMetaObject::activate(this, &staticMetaObject, 0, nullptr);
}

// SIGNAL 1
void MenuPage::uploadPhotosClicked()
{
